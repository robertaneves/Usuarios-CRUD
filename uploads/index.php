        ...
        <?php if ($result && $result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <?php if (!empty($row['rgFrente'])): ?>
                            <a href="uploads/<?php echo htmlspecialchars($row['rgFrente']); ?>" target="_blank">Frente</a>
                        <?php endif; ?>
                        <?php if (!empty($row['rgVerso'])): ?>
                            |
                            <a href="uploads/<?php echo htmlspecialchars($row['rgVerso']); ?>" target="_blank">Verso</a>
                        <?php endif; ?>
                    </td>
                    <td>
